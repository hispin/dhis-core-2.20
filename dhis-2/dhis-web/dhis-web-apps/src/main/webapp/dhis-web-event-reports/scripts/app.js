	...
	LayerWidgetEvent = function(layer) {
		...
		loadDataElements = function(stageId, layout) {
            ...
            if (dataElementStorage.hasOwnProperty(stageId)) {
                ...
                Ext.Ajax.request({
                    url: ns.core.init.contextPath + '/api/programStages.json?filter=id:eq:' + stageId + '&fields=programStageDataElements[dataElement[id,' + ns.core.init.namePropertyUrl + ',type,optionSet[id,name],legendSet[id,name]]]',
                    success: function(r) {
